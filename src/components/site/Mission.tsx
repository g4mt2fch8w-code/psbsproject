        ...
        <div className="lg:col-span-7">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-8 font-display text-[clamp(2.5rem,6vw,5.5rem)] leading-[1.02] text-fog">
              We don't just{" "}
              <em className="text-gold-gradient not-italic">protect</em> nature.
              <br /> We{" "}
              <em className="text-gold-gradient not-italic">become</em> it.
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-fog/65 md:text-lg">
              From the central forests of Maharashtra to the tiger corridors of
              Vidarbha, PSBS works at the intersection of science, community,
              and reverence. Every sapling planted, every camera-trap installed,
              every awareness campaign carried into a village school is a single
              brushstroke on a much larger canvas — a thriving, breathing India.
            </p>
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-fog/55">
              We were founded in 2011 by forest-edge communities who understood
              that conservation cannot succeed without the people who live
              beside the wild. Today, 132 villages partner with us — not as
              beneficiaries, but as co-stewards of the landscapes they have
              known for generations.
            </p>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-fog/55">
              Our approach is deliberately slow and local. We do not chase
              headlines; we chase sapling survival rates, tiger pugmarks in wet
              clay, and the moment a child names their adopted tree.
            </p>
          </Reveal>
            ...
            <div className="relative overflow-hidden rounded-3xl">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <p className="mt-2 font-display text-2xl text-fog">
                  becomes the breath of generations.
                </p>
              </div>
            </div>
          </Reveal>
