            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-white/[0.06] bg-canopy/40 backdrop-blur">
              ...
              >
                {[...Array(20)].map((_, i) => (
                  <path
                    key={i}
                    d={`M0 ${5 + i * 4} Q 50 ${i * 3 + (i % 2 ? 8 : -4)} 100 ${10 + i * 3.5}`}
                    fill="none"
                    stroke="url(#g1)"
                    strokeWidth="0.15"
                  />
